  ...
  describe("Default user", () => {
    test("With valid session", async () => {
      ...
      expect(cacheControl).toBe(
        "no-store, no-chace, max-age=0, must-revalidate",
      );
    ...
    test("With nonexistent session", async () => {
      const nonexistentToken =
        "72704a4200f67c7dbb14710c95e72342c085494b8ac2f5eddfa2a24a7f75d3d3e3c849e836e6e87382c8c7eed0b063f0";
      ...
      expect(responseBody).toEqual({
        ...
        action: "Verifique se este usuário está logado e tenta novamente",
        status_code: 401,
      });
      // Set-Cookie assertions
      const parsedSetCookie = setCookieParser(response, {
